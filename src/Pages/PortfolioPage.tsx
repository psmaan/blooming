...
const PortfolioPage: React.FC = () => {
  ...
  return (
    <div className="portStlye w-full  flex flex-col text-white  min-h-screen bg-black">
      <div className="tb:px-10 px-4 dk:px-20  dk:py-4">
        <Header></Header>
      </div>

      {/* Projectt Showcase */}
      <section
        className={`inertia-container tb:px-10 px-4 dk:px-20  dk:py-4 ${
          isScrolling
