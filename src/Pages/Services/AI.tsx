    ...
    return (
        <div className='w-screen bg-black overflow-hidden flex flex-col items-start'>
            ...
            <div className=' w-full flex overflow-hidden h-screen'>
                ...
                <div className='absolute pl-4 sm:pl-16 lg:pl-24 xl:pl-44 mt-20 flex flex-col items-start'>
                    ...
                    <div className='flex items-center justify-start mt-20'>
                        <h1 className='font-[recoleta] text-[30px] mbl:text-[40px] text-white'>Custom AI</h1>
                        <div className='h-[2px] w-[40px] bg-[#B2FF02] ml-[24px]'></div>
                    </div>
                    <div className='flex items-center justify-start mt-8'>
                        <h1 className='font-[recoleta] text-[30px] mbl:text-[40px] text-white'>Process Optimization</h1>
                        <div className='h-[2px] w-[40px] bg-[#B2FF02] ml-[24px]'></div>
                    </div>
                    <div className='flex items-center justify-start mt-8'>
                        <h1 className='font-[recoleta] text-[30px] mbl:text-[40px] text-white'>AI Integration</h1>
                        <div className='h-[2px] w-[40px] bg-[#B2FF02] ml-[24px]'></div>
                    </div>
                </div>
            </div>
            ...
            <div className="w-full mt-[120px] lg:mt-[200px] relative overflow-hidden">
                <div className="h-[1px] w-full bg-[#B2ff02]"></div>
                <div className="slider message-slider seventy">
                    <div className="slide-track">
                        <div className="slide">
